...
const UZ = {
  ...
  previousSchool: "Oldingi maktabingiz?",
  previousSchoolHint: "masalan, 217-maktab",
  langUZ: "O'zbek",
  langRU: "Rus",
  langEN: "Ingliz",
  ...
  continueExam: "Davom etish",
  nextUp: "Keyingisi",
  toReview: "Ko'rib chiqish →",
  reviewTitle: "Javoblaringizni tekshiring",
  reviewHint: "Javob berilmagan savollar qizil. Ustiga bosib qaytishingiz mumkin.",
  reviewAllAnswered: "Barcha savollarga javob berdingiz ✓",
  reviewUnansweredCount: "{count} ta savolga javob berilmagan",
  backToQuestions: "← Savollarga qaytish",
  goNextSubject: "{subject}ga o'tish →",
  finishExamBtn: "Imtihonni yakunlash",
  confirmNextUnanswered: "Siz {count} ta savolga javob bermadingiz, {current} qismini tugatib rostan ham {next}ga o'tmoqchimisiz?\n\n⚠️ Ogohlantirish: bundan keyin {current}ga qaytib kelolmaysiz.",
  confirmNextAll: "{current} qismini tugatib {next}ga o'tasizmi?\n\n⚠️ Bundan keyin {current}ga qaytib kelolmaysiz.",
  confirmFinishUnanswered: "Siz {count} ta savolga javob bermadingiz, imtihonni yakunlamoqchimisiz?\n\n⚠️ Bundan keyin javoblarni o'zgartirib bo'lmaysiz.",
...
const RU: Dict = {
  ...
  previousSchool: "Ваша прежняя школа?",
  previousSchoolHint: "например, школа №217",
  langUZ: "Узбекский",
  langRU: "Русский",
  langEN: "Английский",
  ...
  nextUp: "Следующий",
  toReview: "Проверить →",
  reviewTitle: "Проверьте свои ответы",
  reviewHint: "Вопросы без ответа выделены красным. Нажмите, чтобы вернуться.",
  reviewAllAnswered: "Вы ответили на все вопросы ✓",
  reviewUnansweredCount: "Без ответа: {count}",
  backToQuestions: "← К вопросам",
  goNextSubject: "Перейти к «{subject}» →",
  finishExamBtn: "Завершить экзамен",
  confirmNextUnanswered: "Вы не ответили на {count} вопрос(ов). Точно завершить часть «{current}» и перейти к «{next}»?\n\n⚠️ Внимание: вернуться к «{current}» будет нельзя.",
  confirmNextAll: "Завершить часть «{current}» и перейти к «{next}»?\n\n⚠️ Вернуться к «{current}» будет нельзя.",
  confirmFinishUnanswered: "Вы не ответили на {count} вопрос(ов). Завершить экзамен?\n\n⚠️ После этого изменить ответы будет нельзя.",
  submitting: "Отправка…",
...
const EN: Dict = {
  ...
  previousSchool: "Your previous school?",
  previousSchoolHint: "e.g. school #217",
  langUZ: "Uzbek",
  langRU: "Russian",
  langEN: "English",
  ...
  reviewHint: "Unanswered questions are red. Tap one to go back.",
  reviewAllAnswered: "You answered every question ✓",
  reviewUnansweredCount: "{count} unanswered",
  backToQuestions: "← Back to questions",
  goNextSubject: "Go to {subject} →",
  finishExamBtn: "Finish exam",
  confirmNextUnanswered: "You left {count} question(s) unanswered. Finish the {current} part and move to {next}?\n\n⚠️ Warning: you won't be able to return to {current}.",
  confirmNextAll: "Finish the {current} part and move to {next}?\n\n⚠️ You won't be able to return to {current}.",
  confirmFinishUnanswered: "You left {count} question(s) unanswered. Finish the exam?\n\n⚠️ You won't be able to change answers afterwards.",
  submitting: "Sending…",
